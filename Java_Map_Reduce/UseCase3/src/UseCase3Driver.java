...
public class UseCase3Driver {
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(UseCase3Driver.class);
		Scan scan = new Scan();
		scan.setCaching(500);
		...
		TableMapReduceUtil.initTableMapperJob(
				"housing_dataset1",      
				scan,	          
				UseCase3Mapper.class,   
				Text.class,	         
				IntWritable.class,
				job);
		 job.setReducerClass(UseCase3Reducer.class);
